...
import IdealTeamPlayerDashboard from './IdealTeamPlayerDashboard'; // BETA: ITP Matrix Self-Assessment
...
export default function Dashboard({
  ...
  const [programsView, setProgramsView] = useState<ProgramHubView>('feedback360'); // BETA: Start with 360 Feedback
          ...
          <div className={`${shellClass}`}>
            ...
            {currentView === 'assessments' && (
              <div className={`${shellClass} space-y-6`}>
                ...
                {programsView === 'performance-review' && (
