  ...
  return (
    ...
    >
      <div className="flex items-start gap-3">
        ...
        <span className="flex-shrink-0 w-6 h-6 bg-blue-600 text-white rounded-full flex items-center justify-center text-xs font-bold mt-1">
          {index + 1}
        </span>
        <div className="flex-1">
          <textarea
            ...
            rows={2}
            className="w-full px-3 py-2 text-sm border border-gray-300 rounded-md mb-2 bg-white text-gray-900 placeholder-gray-400 resize-y"
        ...
        {!isEditing ? (
          <div className="space-y-3">
            ...
            {questions.map((question, index) => (
              <div key={question.id} className="p-3 bg-blue-50 border border-blue-200 rounded-md">
                <div className="flex items-start gap-3">
                  <span className="flex-shrink-0 w-6 h-6 bg-blue-600 text-white rounded-full flex items-center justify-center text-xs font-bold">
                    {index + 1}
                  </span>
                  <div className="flex-1">
                    <p className="text-sm text-gray-700 mb-1">{question.text}</p>
                    <p className="text-xs text-gray-500">Minimum words: {question.minWords || 50}</p>
                  </div>
                </div>
              </div>
            ))}
          ...
          <div className="space-y-4">
            ...
            {!showCustomInput ? (
              <button
                ...
                className="w-full p-3 border-2 border-dashed border-gray-300 rounded-md text-gray-600 hover:border-blue-500 hover:text-blue-600 text-sm font-medium"
              >
                + Add Question
              </button>
            ) : (
              <div className="p-4 border-2 border-blue-300 rounded-md bg-blue-50">
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md mb-3 text-sm bg-white text-gray-900 placeholder-gray-400"
                />
                <div className="mb-3">
                  <label className="block text-sm font-medium text-gray-700 mb-2">
                    Minimum word count:
                  ...
                  <input
                    ...
                    className="w-32 px-3 py-2 border border-gray-300 rounded-md text-sm bg-white text-gray-900"
                  />
