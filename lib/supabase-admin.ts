...
// Note: During build time, these env vars may not be available.
// The client will be created with placeholder values and will fail at runtime
// if these env vars are truly missing, which is the correct behavior.
